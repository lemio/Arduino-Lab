 ...
 */
public class GraphToolbar extends JComponent implements MouseInputListener, KeyListener {
  ...
  public GraphToolbar(Editor editor, JMenu menu) {
    ...
    which[buttonCount++] = START;
    which[buttonCount++] = STOP;
    which[buttonCount++] = COPY;
    currentRollover = -1;
  ...
  protected void loadButtons() {
    Image allButtons = Base.getThemeImage("graph-buttons.gif", this);
